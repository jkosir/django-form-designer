...
class FormDefinitionAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        (_('Settings'), {'fields': ['allow_get_initial', 'log_data', 'success_redirect', 'success_clear', 'display_logged', 'filename_fields', 'save_uploaded_files', 'use_djangular'], 'classes': ['collapse']}),
