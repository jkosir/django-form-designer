...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormDefinition.log_data_to_model'
        db.add_column('form_designer_formdefinition', 'log_data_to_model',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FormDefinition.model_class_name'
        db.add_column('form_designer_formdefinition', 'model_class_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormDefinition.log_data_to_model'
        db.delete_column('form_designer_formdefinition', 'log_data_to_model')

        # Deleting field 'FormDefinition.model_class_name'
        db.delete_column('form_designer_formdefinition', 'model_class_name')
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'model_class_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
